...
<body>
								...
								<div class="row">
									<div class="col-xs-12 col-md-4 col-sm-4">
										<ul class="thumbnails" style="list-style: none">
											<li><a class="thumbnail" href="#"> <img src="../images/goods/${product.image }"></a></li>
										</ul>
									</div>
									<div class="col-xs-12 col-md-8 col-sm-8">
										<div style="margin-left: 30px; margin-top: 20px">
											<h1 class="product-title">${product.name }</h1>
											<ul class="list-unstyled price"><li><h2>${product.priceNow }元</h2></li></ul>
									...
									<div class="col-sm-12 description_oc clearfix">
										...
										<div class="tab-content" style="border: 1px solid #eee; overflow: hidden;">
											<div class="tab-pane active" id="tab-description">${product.info }</div>
										</div>
									</div>
								</div>
								<!-- //显示商品详细信息 -->
	...
	function addCart() {
		...
		window.location.href = "../cart/cartAdd?goodsID=${product.productId}&num=" + num;//调用添加购物车页面，实现将该商品添加到购物车
		}
	</script>
</body>
</html>
