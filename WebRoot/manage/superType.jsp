  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td colspan="3" class="tableBorder_B_dashed"><a href="type_super_add.php"> <img src="../manage/images/manage_ico1.GIF" width="11" height="13">&nbsp;[添加大分类信息]</a></td>
      </tr>
      <tr>
        <td align="right">&nbsp;</td>
      ...
      <tr>
        ...
        <td width="1089" align="center" background="../manage/images/manage_leftTitle_mid.GIF" class="word_white"><b>大分类信息列表</b></td>
        <td width="10" background="../manage/images/manage_leftTitle_right.GIF">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table>
	<!---->
               <form action="type_super_delete" method="post" name="frm"> 
                    ...
                    <table width="100%" height="48"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#E6E6E6"> 
                      ...
                      <c:forEach items="${categoryList }" var="category">
	                      <tr style="padding:5px;"> 
	                        ...
	                        <td align="center"><input name="delid" type="checkbox" class="noborder" value="${category.categoryId }"></td> 
	                      </tr> 
                      </c:forEach>
                    </table> 
